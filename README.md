...
V0.2 是当前正式版本。相较 V0.1 的早期简化界面，本版完成了森林背景与深色半透明玻璃 UI 重构，并增加 Android 移动版。当前开发版进一步合并了协作者的“孤独摇滚”视觉分支：专业模式仍为默认主题，用户可在“数据与外观”中切换动漫主题。两种主题共享同一套行为模型、SQLite 数据结构和业务流程，只改变视觉表达。
