export type UiIconName = "back" | "previous" | "summary" | "notes" | "close" | "chevron";
...
export default function UiIcon({ name, size = 20 }: { name: UiIconName; size?: number }) {
  ...
  if (name === "previous") return <svg {...common}><path d="M9 7 4 12l5 5"/><path d="M4 12h10a6 6 0 0 1 6 6"/><path d="M20 7v4"/></svg>;
